...
const HomePage = () => {
  ...
  return (
    <div className="bg-white">
      <header
        className={`z-50 inset-x-0 top-0 transition-all duration-300 ${
        ...
        <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-48">
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              From classic silhouettes to modern essentials, our collection is
        ...
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-5 xl:gap-x-8">
            {saleProducts.map((product) => (
              <div
                key={product.id}
                className="group relative rounded-lg border border-gray-200 bg-white p-4 shadow-sm hover:shadow-md"
              >
                <img
